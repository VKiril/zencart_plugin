...
//---------------------- functionality part
    ...
    public function getBasePrice($product,$combinations,$attributes){
        ...
        if ($this->feedData['FEED_FIELD_BASE_PRICE_2'] != 'N' ) {
            if (array_key_exists($this->product_options[$this->feedData['FEED_FIELD_BASE_PRICE_2']]['products_options_id'],
                $attributes[$product['products_id']]['options_list'])) {
    ...
    public function getCoupon($product,$combinations,$attributes){
        ...
        if ( $this->feedData['FEED_FIELD_COUPON_3'] != '' ){
